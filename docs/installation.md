...
**Рекомендуемый способ — нативные пакеты.** Начиная с версии 1.8.0 доступны
deb-пакеты для Debian/Ubuntu, rpm-пакеты для RHEL/Fedora и msi-пакет для
Windows. Установка одним кликом, интеграция в меню программ, иконка
приложения, автоматические симлинки. Подробнее — [нативные пакеты](tinvest-packages-20260730/installation.md).

Ниже описаны альтернативные способы установки из готового бинаря и сборки
из исходников.
